...
WheelController::WheelController(int _cw, float _ca, float _w):cam_width(_cw), cam_angle(_ca), w(_w) {
...
std::pair<int, int> WheelController::getSpeeds(int a, float d) const {
	int hw = cam_width/2;
